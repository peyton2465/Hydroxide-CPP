...
namespace ImGui
{
    ...
    // Styles
    IMGUI_API void          StyleColorsHydroxide(ImGuiStyle* dst = NULL);    // new, recommended style (default)
    IMGUI_API void          StyleColorsRed(ImGuiStyle* dst = NULL);    // new, recommended style (default)
    IMGUI_API void          StyleColorsVintage(ImGuiStyle* dst = NULL);    // new, recommended style (default)
    IMGUI_API void          StyleColorsNight(ImGuiStyle* dst = NULL);    // new, recommended style (default)
    ...
    IMGUI_API void          LabelTextClipped(const char* label)              IM_FMTARGS(0); // display text+label aligned the same way as value+label widgets
    IMGUI_API void          LabelText(const char* label, const char* fmt, ...)              IM_FMTARGS(2); // display text+label aligned the same way as value+label widgets
    IMGUI_API void          LabelTextV(const char* label, const char* fmt, va_list args)    IM_FMTLIST(2);
    IMGUI_API void          LabelTextBackground(const char* label)                          IM_FMTLIST(0);
